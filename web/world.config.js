...
window.SHERLOCK_WORLD = {
  ...
  sections: [
    ...
    { id: 'bath', label: 'The bath',
      still: '../assets/scenes/07-bath.jpg',
      scroll: 1.1,
      eyebrow: 'Bathrooms',
      title: 'Hot water and a window that opens.',
      body: 'Plain tile, a proper shower, and daylight to go with it.' },

    { id: 'pool', label: 'The pool',
      still: '../assets/scenes/08-pool.jpg',
